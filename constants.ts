...
  { id: 'imagen-3.0-generate-002', name: 'Imagen 3.0 (Максимальное качество)', enabled: true, maxImages: 8, supportsImageInput: false },
];
...
  { id: 'imagen-3.0-generate-002', name: 'Imagen 3.0 (Качество)' },
];
...
        eyes_shape: ['Миндалевидные', 'Круглое', 'Глубоко посаженные', 'С опущенными уголками', 'С нависшим веком (hooded eyes)'],
...
        eyes_shape: ['Миндалевидные', 'Круглое', 'Глубоко посаженные'],
...
        eyes_shape: ['Миндалевидные', 'Круглое', 'Глубоко посаженные', 'С опущенными уголками'],
...
        eyes_shape: ['Миндалевидные', 'Круглое'],
        eye_color: ['Карий', 'Темно-карий (почти черный)'],
...
    'Латиноамериканский': {
        skin_tone: ['Оливковая / Средиземноморская', 'Светло-коричневая', 'Коричневая (Азиатская / Латиноамериканская)'],
        eyes_shape: ['Миндалевидные', 'Круглое', 'Карие'],
